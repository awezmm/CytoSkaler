...
public class AutoThresholder {
	private static final String[] methods = {"Huang", "Intermodes", "IsoData", "Li", "MaxEntropy", "Mean", "MinError(I)", "Minimum",
		"Moments", "Otsu", "Percentile", "RenyiEntropy", "Shanbhag", "Triangle", "Yen"};
	private static final int HUANG=0, INTERMODES=1, ISODATA=2, LI=3, MAXENTROPY=4, MEAN=5, MINERROR=6, MINIMUM=7,
		MOMENTS=8, OTSU=9, PERCENTILE=10, RENYIENTROPY=11, SHANBHAG=12, TRIANGLE=13, YEN=14;
	...
	public int getThreshold(String method, int[] histogram) {
		...
		if (index<0) throw new IllegalArgumentException("Method not found");
		int threshold = 0;
		switch (index) {
